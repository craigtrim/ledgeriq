...
API Gateway wrapper for line items extraction Step Function. Lists files by hash, invokes line items extractor, and returns structured array of itemized line items with description, quantity, unit price, and total.

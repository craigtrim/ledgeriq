...
STATE_MACHINE_ARN = "arn:aws:states:us-west-2:210182908261:stateMachine:classify-document-type"
...
def handler(event: dict, _) -> dict:
    """API Gateway handler for classify-document-type Step Function.

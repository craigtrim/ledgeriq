...
Extracts the primary service date from documents using Claude 4.5 Sonnet. Uses common extractor dates as candidates and applies document-type-specific logic to identify the canonical service date.
